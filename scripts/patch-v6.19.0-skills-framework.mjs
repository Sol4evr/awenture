...
console.log(JSON.stringify({release:'6.19.0',skillsFramework:'awenture-skills-v1',parentSkills:'parent-lifecycle-only',progressionEnabled:false,dailyPracticeMix:'unchanged'}));
