...
formal+='\n/* v6.13.1.1 iPad-safe paged historical-paper viewer; native page selector captured at window input/change; source-review mode retained. */\n';
