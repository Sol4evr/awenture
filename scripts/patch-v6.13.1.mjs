...
formal+='\n/* v6.13.1.1 iPad-safe historical paper pager diagnostic; source-review mode retained. */\n';fs.writeFileSync(formalPath,formal);
...
console.log(JSON.stringify({releaseOverlay:'6.13.1.1',historicalPapers:runtime.papers.length,pagedViewer:'PDF.js local runtime',pageSelector:'native-select',pagerDiagnostic:'dataset-state',sourceReview:'retained'}));