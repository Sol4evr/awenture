...
html=html.replace('</head>','<link rel="stylesheet" href="/premium.css?v=6101"><link rel="stylesheet" href="/practice-flow.css?v=6101"></head>');
html=html.replace('</body>','<script src="/premium.js?v=6101" defer></script></body>');
...
console.log(JSON.stringify({release,baselineRelease:m.release,baselineSha256:sha,baselineBytes:baseline.length,uiModules:['premium-v1','practice-flow-v1'],output:'dist'}));
