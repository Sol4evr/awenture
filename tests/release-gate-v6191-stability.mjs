...
assert(invariants.productionBaseline?.release==='6.19.1','immutable production baseline release drift');
assert(invariants.productionBaseline?.gitSha==='7c9725010ad635bd5646c306ddd18ff39aca9317','immutable production baseline SHA drift');
...
if(workflow!==null)assert(workflow.includes('include-hidden-files: true'),'exact-SHA artifact marker must be uploaded for browser consumers');
