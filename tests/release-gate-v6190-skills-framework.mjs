...
if(!/^6\.19\.\d+$/.test(packageJson.version))throw new Error(`Package release marker is outside the v6.19 framework line: ${packageJson.version}`);
...
console.log(JSON.stringify({release:packageJson.version,framework:fw.version,mapping:fw.mappingVersion,grades:fw.grades.length,subjects:fw.subjects.length,skills:fw.skills.length,progressionEnabled:fw.progressionEnabled,parentLifecycleOnly:true,gate:'PASS'}));
