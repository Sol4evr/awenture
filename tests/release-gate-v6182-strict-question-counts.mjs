...
const reviewedDigital2012='source/original-icas/year3/Digital A/Digital AB 2012.pdf';
const reviewedDigital2012Entry=qa.papers?.[reviewedDigital2012];
if(!reviewedDigital2012Entry?.questionCountVerified||reviewedDigital2012Entry.questionCount!==30||reviewedDigital2012Entry.method!=='reviewed-exact-source-evidence')throw new Error('Digital AB 2012 must be verified at 30 only through reviewed exact-source evidence');
for(const bad of ['source/original-icas/year3/English A/English A 2012.pdf','source/original-icas/year3/Maths A/Maths A 2017.pdf','source/original-icas/year3/Science A/Science A 2017.pdf'])if(qa.papers?.[bad]?.questionCountVerified)throw new Error(`known cross-subject false match survived strict gate: ${bad}`);
