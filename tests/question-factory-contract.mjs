...
if(c.version!=='aw-qf-1.0.0')fail('unexpected generator version');
...
console.log(JSON.stringify({questionFactoryContract:'PASS',version:c.version,privateSchema:c.privateSchema,directPublish:false,expertReview:true,providerCost:0,subjects:c.generation.subjects}));
