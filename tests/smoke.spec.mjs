...
test('feature-complete learner shell, iPad-safe historical papers and gated bonus challenge', async ({ page }) => {
  ...
  await expect(page.locator('[data-aw-page-select]')).toBeVisible();
  await expect(page.locator('[data-aw-page-select]')).toHaveValue('1');
  ...
  await page.locator('[data-aw-page-select]').selectOption('2');
  await expect(page.locator('[data-aw-page-select]')).toHaveValue('2');
  await expect(page.locator('[data-aw-page-label]')).toHaveText('Page 2 of 18');
  await page.locator('[data-aw-page-select]').selectOption('1');
  await expect(page.locator('[data-aw-page-select]')).toHaveValue('1');
  await expect(page.locator('[data-aw-page-label]')).toHaveText('Page 1 of 18');
