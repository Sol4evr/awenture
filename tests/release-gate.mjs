...
for(const x of ['content="6.13.2.0',"RELEASE='6.13.2.0'",'oc-ready-progress-v1','My Collection','Made with love by Arthur Wang (daddy), 2026','window.AW_BANK=[]','window.AW_BONUS_BANK=','window.__AW_BONUS_API','window.__AW_ORIGINAL_PAPERS=','/formal-tests.css?v=61320','/formal-tests.js?v=61320','visualTarget=3','visualMax=4','unsafeVisualIds=new Set'])if(!html.includes(x))throw new Error(`Missing ${x}`);
