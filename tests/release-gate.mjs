...
for(const x of ['content="6.14.0',"RELEASE='6.14.0'",'oc-ready-progress-v1','My Collection','Made with love by Arthur Wang (daddy), 2026','window.AW_BANK=[]','window.AW_BONUS_BANK=','window.__AW_BONUS_API','window.__AW_ORIGINAL_PAPERS=','/formal-tests.css?v=61400','/formal-tests.js?v=61400','visualTarget=3','visualMax=4','unsafeVisualIds=new Set'])if(!html.includes(x))throw new Error(`Missing ${x}`);
...
for(const marker of ['PROGRESS_KEY','transformHome','transformParent','document.querySelector(\'[data-a="progress"]\')?.remove()','allSkillRows','subjectRows','spectrumRow','subjectSummary','subskillSections','Not attempted yet','ICAS Y2','ICAS Y3','NAPLAN Y3','ICAS Y4','OC'])if(!insights.includes(marker))throw new Error(`Insights missing: ${marker}`);
